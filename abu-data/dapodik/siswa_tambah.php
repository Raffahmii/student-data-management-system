...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nisn) || empty($nama) || empty($tanggal_lahir) || empty($jenis_kelamin) || $kelas_id <= 0) {
        ...
        if ($cek->fetch()) {
            ...
            // Hitung tangga berdasarkan kelas (backend only)
            ...
            if ($stmt->execute([$nisn, $nama, $tanggal_lahir, $jenis_kelamin, $alamat, $no_hp, $kelas_id, $tahun_ajaran_id, $tangga, $status])) {
                logActivity('TAMBAH SISWA', "Menambah siswa: NISN={$nisn}, Nama={$nama}");
...
<head>
    ...
    <title>Tambah Siswa - Admin TU</title>
...
<div class="main-content">
    ...
    <div class="page-header">
        ...
        <h1><i class="fas fa-user-plus" style="color: #1e4a6b;"></i> Tambah Siswa Baru</h1>
    </div>
    ...
    <div class="form-container">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                <label>Alamat</label>
                <textarea name="alamat" class="form-control"><?= htmlspecialchars($_POST['alamat'] ?? '') ?></textarea>
            </div>
            <div class="form-group">
                <label>No. HP</label>
            ...
            <div class="form-group">
                ...
                <select name="kelas_id" class="form-control" required>
                    ...
                    <?php foreach ($kelas_list as $k): ?>
                        <option value="<?= $k['id'] ?>" <?= ($_POST['kelas_id']??'') == $k['id'] ? 'selected' : '' ?>><?= htmlspecialchars($k['nama_kelas']) ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            <div class="form-group">
