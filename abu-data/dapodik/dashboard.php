...
<div class="main-content">
    ...
    <div class="dashboard-grid">
        ...
        <div class="dashboard-card">
            ...
            <div class="card-body">
                ...
                <?php endif; ?>
                <a href="audit_log.php" style="display: block; text-align: center; margin-top: 1rem; padding: 0.5rem; background: #f8fafc; border-radius: 12px; text-decoration: none; font-size: 0.8rem; color: #1e4a6b; font-weight: 500;">
                    <i class="fas fa-arrow-right"></i> Lihat semua aktivitas
                </a>
            </div>
        </div>
    </div>
    ...
    <!-- Aksi Cepat - Hanya menu yang ada di sidebar dapodik -->
    <div class="dashboard-card" style="margin-top: 1.5rem;">
        ...
        <div class="card-body">
            <div class="quick-actions">
                ...
                <a href="../dapodik/tahun_ajaran.php" class="quick-btn">
                ...
                <a href="audit_log.php" class="quick-btn">
                ...
                <a href="../auth/logout.php" class="quick-btn">
