...
");
$kelas_terpadat->execute([$tahun_aktif_id]);
$kelas_terpadat = $kelas_terpadat->fetchAll();
...
<div class="main-content">
    ...
    <div class="dashboard-grid">
        ...
        <div class="dashboard-card">
            <div class="card-header">
                <h3><i class="fas fa-user-plus"></i> 10 Siswa Terbaru</h3>
            </div>
            <div class="card-body">
    ...
    <!-- Aksi Cepat - Sesuai dengan Sidebar Kepala Sekolah -->
    <div class="dashboard-card">
        <div class="card-header">
        ...
        <div class="card-body">
            <div class="quick-actions">
                ...
                <a href="guru.php" class="quick-btn">
                    <i class="fas fa-chalkboard-user"></i>
                    <span>Data Guru</span>
                </a>
                <a href="riwayat_siswa.php" class="quick-btn">
